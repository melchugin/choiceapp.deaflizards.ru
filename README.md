...
В проекте присутствует отдельные среды для тестирования, рабочий стенд и продакшн. Ниже приведена архитектура docker-контейнеров, а также внутренняя сеть.
