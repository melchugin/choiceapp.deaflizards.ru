...
Получены статистические данные по численным характеристикам вакансий, ниже приведена визуализация медианной зарплаты по группам вакансий. Из-за специфики источника данных (https://trudvsem.ru/opendata), большинство вакансий в гос. секторе, зарплаты сильно отличаются от коммерческого IT. Данные были выбраны ввиду их относительной простоты получения - открыто выложены в виде `.xml`. Механизмы анализа, работающие на приведенных данных будут аналогично работать на актуальных данных по рынку IT-вакансий.
